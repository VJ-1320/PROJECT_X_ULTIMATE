...
export default function AuthScreen() {
  ...
  return (
    <div style={{
      ...
      {/* Test indicator */}
      <div style={{position:'fixed',top:10,left:10,color:'var(--c)',fontFamily:'Share Tech Mono',fontSize:'.7rem',zIndex:9999}}>
        ✓ APP LOADED
      </div>
      ...
      <div style={{
        ...
        {mode === 'register' ? (
          ...
          <div style={{ animation:'fadeIn .25s' }}>
            ...
            {/* --- NEW HARDWARE BIOMETRIC GATE --- */}
            {mode === 'login' && <BiometricGate username={username} onSuccess={enterApp} />}
            {/* ---------------------------------- */}
