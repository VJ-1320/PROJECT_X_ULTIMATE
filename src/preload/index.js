...
// NEW: Hardware Security API (Biometrics/Windows Hello)
contextBridge.exposeInMainWorld('security', {
  linkHardware: (username) => ipcRenderer.invoke('security:link-hardware', username),
  verifyHardware: (data) => ipcRenderer.invoke('security:verify-hardware', data)
})